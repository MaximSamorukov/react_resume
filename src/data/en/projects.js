export const projects = [
  ...
  },
  {
    ...
    description:
      "Parsing processing and presentation data from api.covid19api.com about covid spreading in the world and in different countries. HTML, CSS, JS",
  ...
  },
  {
    title: "Puzzle",
    description:
      "Puzzle game that enables game field change and best results saving.",
    repositoryUrl:
  ...
  },
  {
    title: "Charts",
    description:
      "Web application to show latest news and stock prices. JS, Bootstrap, React, Redux",
  ...
  {
    title: "Calculator",
    description: "Standard calculator with some additional functions.",
    repositoryUrl:
  ...
  },
  {
    title: "Momentum",
    description:
      "Web application, that is using outside rest api services to get and show weather info in any place according to user's request, famous people quotes, current time and so on. Background image is changing according to the day time. The application is working with local storage.",
